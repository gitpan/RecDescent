...
This document refers to RecDescent version 1.26.
...
the behaviour of the parser. There are six directives:
C<E<lt>commitE<gt>>, C<E<lt>uncommitE<gt>>, C<E<lt>rejectE<gt>>,
C<E<lt>resyncE<gt>>, C<E<lt>errorE<gt>>, and C<E<lt>matchrule<gt>>.
